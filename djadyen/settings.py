...
DJADYEN_SERVER_KEY = dj_settings.DJADYEN_SERVER_KEY
DJADYEN_CLIENT_KEY = dj_settings.DJADYEN_CLIENT_KEY
DJADYEN_ENVIRONMENT = dj_settings.DJADYEN_ENVIRONMENT
DJADYEN_APPNAME = getattr(dj_settings, "DJADYEN_APPNAME", "Djadyen Payment")
DJADYEN_MERCHANT_ACCOUNT = dj_settings.DJADYEN_MERCHANT_ACCOUNT
...
DJADYEN_ORDER_MODELS = dj_settings.DJADYEN_ORDER_MODELS
DJADYEN_NOTIFICATION_KEY = dj_settings.DJADYEN_NOTIFICATION_KEY
