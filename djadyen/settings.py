...
DJADYEN_SERVER_KEY = getattr(dj_settings, "DJADYEN_SERVER_KEY", "AQE1hmfxKYnGYhNBw0m/n3Q5qf3VZopZGIFLeXdCz2uGn2FCjdNkEcCgSFvtVBqr0UeIJcQ7SXwQwV1bDb7kfNy1WIxIIkxgBw==-HI5Mbes1zzL4CULcJvoTw56Ro4dE5Sjj3/F4cqkb8+4=-VYB,}T8bfN#Vt&H}")
DJADYEN_CLIENT_KEY = getattr(dj_settings, 'DJADYEN_CLIENT_KEY', "test_TAWAPT2EKBBTJIXH5NWY2JVZEUOOSA3A")
DJADYEN_ENVIRONMENT = getattr(dj_settings, 'DJADYEN_ENVIRONMENT', "test")
DJADYEN_APPNAME = getattr(dj_settings, 'DJADYEN_APPNAME', "test")
DJADYEN_MERCHANT_ACCOUNT = getattr(dj_settings, 'DJADYEN_MERCHANT_ACCOUNT', "Artis_Dagtickets")
